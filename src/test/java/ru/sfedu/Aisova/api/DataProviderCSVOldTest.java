...
public class DataProviderCSVOldTest extends TestBase {

    private static Logger log = LogManager.getLogger(DataProviderCSVOldTest.class);
 ...
 */
    ...
    public void insertServiceSuccess() throws CsvRequiredFieldEmptyException, IOException, CsvDataTypeMismatchException {
        ...
        List<Service> listService = new ArrayList<>();
        listService.addAll(getListService());
        DataProviderCSVOld instance = new DataProviderCSVOld();
    ...
    void insertSalonSuccess() throws CsvRequiredFieldEmptyException, IOException, CsvDataTypeMismatchException {
        ...
        List<Master> listMaster = new ArrayList<>();
        listMaster.addAll(getListMaster());
        List<Master> master1 = new ArrayList<>();
        List<Master> master2 = new ArrayList<>();
        List<Master> master3 = new ArrayList<>();
        master1.add(listMaster.get(1));
        master2.add(listMaster.get(0));
        master2.add(listMaster.get(1));
        master2.add(listMaster.get(2));
        master3.add(listMaster.get(0));
        master3.add(listMaster.get(2));
        Salon salon1 = createSalon(1, "address1", master1);
        Salon salon2 = createSalon(2, "address2", master2);
        Salon salon3 = createSalon(3, "address3", master3);
